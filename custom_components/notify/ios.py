...
class iOSNotificationService(BaseNotificationService):
    ...
    def send_message(self, message="", **kwargs):
     ...
     #           print(key)
    #        print(kwargs.get(ATTR_DATA['data']))
    #        print(data)
   #         print(data[ATTR_DATA][push])
   #         print(kwargs.get(ATTR_DATA[1]))
   #         print(kwargs.get(ATTR_DATA[push][badge]))
   #     if kwargs.get(ATTR_DATA.badge) is not None:
   #         data[ATTR_DATA.badge] = int(kwargs.get(ATTR_DATA.badge))
